...
// window.cyclops_nft_contract_address = '0x372f010Ae7A965911b4919f062E8bE2eaa43CB96'; //kovan
...
// 	  crypto_icons['CYTR'] = '<span class="cytr-icon"></span>';
...
// 	await Promise.all( [initDataProviderContractReader(),initVotesCalcContractReader(),initUsageCalcContractReader()]);
...
// 		 	let [data, dec] = await Promise.all([ contract.methods.getData('CYTRUSD').call({from:userObject.account}), contract.methods.getDecimals('CYTRUSD').call({from:userObject.account})]);
